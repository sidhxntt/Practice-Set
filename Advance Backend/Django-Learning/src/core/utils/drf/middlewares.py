def middlewares():
    ...
    # 'core.middleware.RawBodyMiddleware',
    ...
    'allauth.account.middleware.AccountMiddleware',
            # Custom authentication middleware (add after AuthenticationMiddleware)
    'authentication.middleware.UserActivityMiddleware',  # Tracks last_active
    'authentication.middleware.TimezoneMiddleware',     # Sets timezone
    'authentication.middleware.IPTrackingMiddleware',   # Logs IPs (optional)
    ...
    # 'elasticapm.contrib.django.middleware.TracingMiddleware',  # APM tracing
    'core.utils.logging.api_audit.RequestLoggingMiddleware',  # (Custom Middleware) Logs details about every incoming request: method, path, user, IP, response time, etc.
