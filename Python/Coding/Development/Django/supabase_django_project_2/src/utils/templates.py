...
def templates(BASE_DIR):
    ...
    return  [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], # This is a list of filesystem paths where Django should look for templates outside your app directories.  is where you'd put shared/global templates like a base layout (base.html).
