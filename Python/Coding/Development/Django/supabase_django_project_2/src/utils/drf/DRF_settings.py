def DRF(env):
    ...
    'EXCEPTION_HANDLER': 'utils.logging.exception_handler.custom_exception_handler', # Points to a custom function to format exceptions globally. Useful for returning structured JSON errors instead of default DRF error responses.
}
